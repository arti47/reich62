...
export const PANELS = {
  ...
  sheetSkills: { lede: 'What your character is good at, and the dice each skill rolls.', detail: 'The pool preview shows how many plain and upgraded dice you get: the higher of skill and its characteristic sets the number of dice, and the lower upgrades that many of them.' },
