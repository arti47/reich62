...
export const PANELS = {
  ...
  sheetDread: { lede: 'When they see something genuinely disturbing, call for a dread check — and record what it leaves behind.', detail: 'It is an ordinary Discipline check at a difficulty set by how bad the thing was, once per circumstance per scene. A simple failure leaves them disoriented; a bad one costs strain; a severe one — three threat or a despair — leaves a lasting scar, rolled on the book\'s trauma table when the journey module is on. Scars are addressed through play and downtime, not by a check.' },
